...
const Cart = () => {
  ...
  return (
    <div className="bg-gray-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 min-h-screen pt-24 sm:pt-28 md:pt-32 pb-16 px-3 sm:px-6 lg:px-8 transition-colors duration-300">
